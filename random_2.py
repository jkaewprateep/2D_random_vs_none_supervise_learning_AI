...
: Variables
"""""""""""""""""""""""""""""""""""""""""""""""""""""""""
actions = { "none_1": K_h, "left_1": K_a, "down_1": K_s, "right_1": K_d, "up___1": K_w, "left_2": K_a, "right_2": K_d, "up___2": K_w, "right_3": K_d }
...
def random_action( ): 
	...
	coeff_06 = 15 * 512 / ( info2 % 470 )	# left
	coeff_07 = 15 * 512 / ( ( 512 - info2 ) % 470 )	# right
	coeff_08 = 160 * 512 / ( info1 % 448 ) # left
	coeff_09 = 320 * 512 / ( ( 512 - info1 ) % 447 )	# right
	
	print( "coeff_01: " + str( coeff_01 ) + " coeff_02: " + str( coeff_02 ) + " coeff_03: " + str( coeff_03 ) + " coeff_04: " + str( coeff_04 ) + " coeff_05: " + str( coeff_05 ) 
			+ " coeff_06: " + str( coeff_06 ) + " coeff_07: " + str( coeff_07 ) + " coeff_08: " + str( coeff_08 ) + " coeff_09: " + str( coeff_09 )
			+ " info2: " + str( info2 ) + " info1: " + str( info1 )
	)
	
	temp = tf.ones([1, 9], dtype=tf.float32)
	temp = tf.math.multiply(temp, tf.constant([ coeff_01, coeff_02, coeff_03, coeff_04, coeff_05, coeff_06, coeff_07, coeff_08, coeff_09 ], shape=(9, 1), dtype=tf.float32))
